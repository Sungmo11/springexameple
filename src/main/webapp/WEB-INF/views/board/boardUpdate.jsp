		...
		if(obj != null)
		{
			...
			if(filesLen > 0)
			{
				for(var a = 0; a < filesLen; a++)
				{
					...
					fileStr += "<button type='button' class='btn black ml15' style='padding:3px 5px 6px 5px;' onclick='setDeleteFile("+ boardSeq +", "+ fileNo +")'>X</button>";
				}
			}
			else
			{
	...
	<div id="container">
		<div class="inner">
			...
			<div class="btn_right mt15">
				...
				<button type="button" class="btn black" onclick="updateBoard();">수정하기</button>
			</div>
		</div>
	</div>
</div>
