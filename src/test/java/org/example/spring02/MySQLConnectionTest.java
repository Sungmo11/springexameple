...
public class MySQLConnectionTest {
	...
	static final String URL = "jdbc:mysql://localhost:3306/springsqlexample?useSSL=false&serverTimezone=UTC";
	static final String USERNAME = "root";
	static final String PASSWORD = "07230628";
	...
	public void getMySQLConnectionTest()
	{
		...
		try 
		{
			logger.info("================================= My SQL Connection START =================================");
//			System.out.println("================================= My SQL Connection START =================================");
...
//		System.out.println("================================= My SQL Connection END =================================\n");
		logger.info("================================= My SQL Connection END =================================");
	}
